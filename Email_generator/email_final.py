...
def parse_test_results(test_names):
    # Connect to MongoDB
    client = MongoClient("mongodb+srv://ShreeshaShetty:Shreesha7%40@cluster0.ldusz7x.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
    db = client["TestLogs"]
...
sender_email = 'shettysandip769@gmail.com'
sender_password = 'fkxspywbtrukaihf'
